...
def total_volume(timestamp_start, time_increment=300):
    ...
    while start_time <= current_time:
        ...
        try:
            ...
            daily_volume_data = len(daily_volume_json['data']['transactions'])

            for swap_data_dictionary in daily_volume_json['data']['transactions']:
                for swap_usd in swap_data_dictionary['swaps']:
                    for
